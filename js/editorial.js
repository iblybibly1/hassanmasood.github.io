...
(function () {
  ...
  (function () {
    ...
    var FI = {
      ...
      'services-hero-p2': 'Jokainen toimeksianto on käytännöllinen, ei teoreettinen. Olen toteuttanut nämä järjestelmät omakohtaisesti — CBAM-ilmoittajatilien rekisteröinnistä ja toimittajatietojen keräyksestä satojen kohteiden osalta aina täydellisten CRM-putkien rakentamiseen ja verkkokauppakanavien avaamiseen kansainvälisesti. Saat tekijän, ei vain neuvojan.',
      ...
      'svc-pg-03-desc': 'Kohderyhmätutkimus, kanavamix-strategia, KPI-koontinäytöt, kuukausikatsauksen kehykset — dataohjattu alusta alkaen. Jokainen kampanja on mitattavissa ja optimoitavissa.',
      'svc-pg-04-name': 'Myynti &amp; <span class="em">CRM</span>',
      'svc-pg-04-desc': 'Kontaktointijärjestelmät, putken toiminnot, B2B- ja verkkokauppa. CRM-suunnittelu ja käyttöönotto HubSpotissa tai Salesforcessa. Olen pyörittänyt näitä työnkulkuja — en vain neuvonut niistä.',
      'svc-pg-05-name': 'Kansainvälinen <span class="em">Laajeneminen</span>',
      'svc-pg-05-desc': 'Rajat ylittävä verkkokauppa, toimittaja-auditointi, EU-tuontivaatimustenmukaisuus, lokalisointi kuudella kielellä. Olitpa menossa Suomeen, EU:hun tai Etelä-Aasian markkinoille — tiedän polun.',
      'svc-pg-06-name': 'Brändi &amp; <span class="em">Sisältö</span>',
      'svc-pg-06-desc': 'Brändiääni, verkkosivuteksti, sähköpostikampanjat ja pitchdeckit — laadittu useilla kielillä kansainvälisille yleisöille.',
      'svc-pg-07-name': 'Sosiaalinen &amp; <span class="em">Maksetut Mainokset</span>',
      'svc-pg-07-desc': 'Instagram ja Facebook orgaaninen sisältö sekä maksettujen mainosten hallinta. Luovuus, kohdentaminen, optimointi ja läpinäkyvä raportointi.',
      'svc-pg-08-name': 'Liiketoiminnan <span class="em">Kehitys</span>',
      'svc-pg-08-desc': 'Markkinoille pääsyn strategia, kumppanuuksien kehittäminen, tulojen monipuolistaminen — rakennettu todellisesta operatiivisesta kokemuksesta kolmella mantereella.',
      /* services page — bottom CTA */
      'services-cta-eyebrow': 'Epävarma, mikä sopii?',
      'services-cta-title': 'Puhutaan <span class="em">ensin.</span>',
      'services-cta-p': 'Useimmat toimeksiannot alkavat lyhyellä keskustelulla. Kerro, mitä teet, ja kerron rehellisesti, voiko ja miten voin auttaa.',
      'services-cta-btn': 'Aloita keskustelu →',
      ...
      'about-bio-1': 'Teen kestävää liiketoimintaa. Istun siinä risteyksessä, jossa viranomaiset, operatiivinen arki ja tuloksenteko kohtaavat. Autan yrityksiä ymmärtämään, mitä EU-viitekehykset kuten CBAM ja CSRD todella vaativat, rakennan sisäiset järjestelmät vaatimusten täyttämiseksi ja varmistan, että vaatimustenmukaisuus ei vain vähennä riskiä vaan tuottaa todellista liiketoiminta-arvoa.',
